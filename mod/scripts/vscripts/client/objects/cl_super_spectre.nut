...
void function ClSuperSpectre_Init()
{
	...
	Cl_SuperSpectreModel_Init( $"models/robots/super_spectre/super_spectre_v1.mdl" )
}
...
void function CreateCallback_SuperSpectre( entity super_spectre )
{
	...
	// I'd like to init them manually though
	/*
	if ( file.initialized )
		return
...
void function Cl_SuperSpectreModel_Init( asset model_name )
{
	//----------------------
	// ACL Lights - Friend
	//----------------------
	...
	ModelFX_BeginData( "SuperSpectreDamage", model_name, "all", true )
		//----------------------
		// Health effects
		//----------------------
