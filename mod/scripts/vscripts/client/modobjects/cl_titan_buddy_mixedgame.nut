global function ClTitanBuddy_MixedGame_Init

void function ClTitanBuddy_MixedGame_Init( asset titan_model )
{
	// allow server turning off effects
    bool enableServerLoopingEffects = GetCurrentPlaylistVarInt( "bt_titan_server_effects", 0 ) == 1
